 ...
 */
public class DatePickerDialogCompat extends DialogFragment implements
        OnClickListener, DatePickerController {

    private static final String TAG = "DatePickerDialogCompat";
    ...
    public interface OnDateSetListener {
         ...
         */
        void onDateSet(DatePickerDialogCompat dialog, int year, int monthOfYear, int dayOfMonth);
    }
     ...
     */
    public static DatePickerDialogCompat newInstance(OnDateSetListener callBack, int year,
            int monthOfYear,
            int dayOfMonth) {
        DatePickerDialogCompat ret = new DatePickerDialogCompat();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDoneButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                tryVibrate();
                if (mCallBack != null) {
                    mCallBack.onDateSet(DatePickerDialogCompat.this, mCalendar.get(Calendar.YEAR),
